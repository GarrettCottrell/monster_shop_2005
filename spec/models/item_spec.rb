...
describe Item, type: :model do
  ...
  describe "instance methods" do
    ...
    it "#status" do
      ...
      expect(chain.order_item_id(order_1.id)).to eq(order_item_1.id)
    end
    ...
    it "#discounted_price" do
      ...
      expect(chain.discounted_price(chain.order_item(order_1.id).quantity, order_1.id)).to eq(2100)
    end
    ...
    it "#discounted_unit_price" do
      ...
      expect(chain.discounted_unit_price(chain.order_item(order_1.id).quantity)).to eq(35)
    end
