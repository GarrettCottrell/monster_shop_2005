...
describe Merchant, type: :model do
  ...
  describe 'instance methods' do
    ...
    it '#find_discount_quantity' do
      ...
      expect(bike_shop.find_discount(order_item_1.quantity)).to eq(discount_5)
      expect(bike_shop.find_discount(order_item_2.quantity)).to eq(discount_4)
      expect(bike_shop.find_discount(order_item_3.quantity)).to eq(discount_3)
      expect(bike_shop.find_discount(order_item_4.quantity)).to eq(discount_2)
      expect(bike_shop.find_discount(order_item_5.quantity)).to eq(discount_1)
    end
    ...
    it '#find_discount_quantity' do
      ...
      expect(bike_shop.find_discount_amount(order_item_1.quantity)).to eq(discount_5.percent_discount)
      expect(bike_shop.find_discount_amount(order_item_2.quantity)).to eq(discount_4.percent_discount)
      expect(bike_shop.find_discount_amount(order_item_3.quantity)).to eq(discount_3.percent_discount)
      expect(bike_shop.find_discount_amount(order_item_4.quantity)).to eq(discount_2.percent_discount)
      expect(bike_shop.find_discount_amount(order_item_5.quantity)).to eq(discount_1.percent_discount)
    end
  end
end
