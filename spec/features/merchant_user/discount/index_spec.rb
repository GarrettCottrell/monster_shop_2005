...
RSpec.describe 'merchants discount index page', type: :feature do
  describe 'As a merchant user' do
    ...
    to create a new discount, as well as update/delete each discount' do
      ...
      expect(page).to have_content("Discount ID #: #{discount_1.id} Quantity: 10 Percent Discount: 2")
      expect(page).to have_content("Discount ID #: #{discount_2.id} Quantity: 20 Percent Discount: 5")
      expect(page).to have_content("Discount ID #: #{discount_3.id} Quantity: 30 Percent Discount: 10")
